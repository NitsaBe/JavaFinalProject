...
public abstract class PieceDevTools {
    private final int color;
    private SquareDevTools currentSquare;
    private BufferedImage img;
    
    public PieceDevTools(int color, SquareDevTools initSq, String img_file) {
        this.color = color;
    ...
    public boolean move(SquareDevTools fin) {
        PieceDevTools occup = fin.getOccupyingPiece();
    ...
    public SquareDevTools getPosition() {
        return currentSquare;
    }
    
    public void setPosition(SquareDevTools sq) {
    ...
    public int[] getLinearOccupations(SquareDevTools[][] board, int x, int y) {
        int lastYabove = 0;
        int lastXright = 7;
        int lastYbelow = 7;
        int lastXleft = 0;
    ...
    public List<SquareDevTools> getDiagonalOccupations(SquareDevTools[][] board, int x, int y) {
        LinkedList<SquareDevTools> diagOccup = new LinkedList<SquareDevTools>();
    ...
    public abstract List<SquareDevTools> getLegalMoves(BoardDevTools b);
}